...
"participant": "919122814903@s.whatsapp.net"
}}}}
//=================================================//
const doc = { 
key: {
...
//=================================================//
const bal= (teks) => {
haikal.sendMessage(m.chat, { text: teks, contextInfo:{"externalAdReply": {"title": `ASHISH ${ngazap(prefix)}`,"body": `ASHISH ${ngazap(prefix)}`, "previewType": "PHOTO","thumbnailUrl": ``,"thumbnail": kalimage,"sourceUrl": `https://chat.whatsapp.com/Jh0EznQhxbkCHIre0L2bTr`}}}, { quoted: doc })
} 
// Target
const reply = (teks) => {
return haikal.sendMessage(m.chat, { text: teks, contextInfo:{"externalAdReply": {"title": `SC ASHISH`,"body": `Selamat ${salam} kak ${pushname}`, "previewType": "PHOTO","thumbnailUrl": ``,"thumbnail": kalimage,"sourceUrl": `https://chat.whatsapp.com/Jh0EznQhxbkCHIre0L2bTr`}}}, { quoted: hw })
} 
//=================================================//
const anjay = (teks) => {
 haikal.sendMessage(m.chat, { image: kalimage, caption: teks, contextInfo:{"externalAdReply": {"title": `SC ASHISH`,"body": `Selamat ${salam} kak ${pushname}`,
previewType: "PHOTO",
...
await haikal.sendButtonText(m.chat, buttonsntnssfww, `Haii 👋 ASHISH ${pushname} have a nice day ${salam} *ASHISH*
...
let user = global.db.data.users[m.sender]
anjay(`
Hello Saya Bot ASHISH${user.afkReason ? ' Baiklah ' + user.afkReason : ''}
...
"optionName": "KATANYA KEBAL"
	...
	{
"optionName": "SALAM BROTHER BY ASHISH"
	}
],
...
"inviteExpiration": `MY NAME ASHISH${ngazap(prefix)}`,
"groupName": `MY NAME ASHISH${ngazap(prefix)}`,
...
user.afkReason = text
deploy(`${m.pushName} Hello Saya Bot ASHISH${text ? ': ' + text : ''}`)
}
break
//=================================================//
case 'bugstik':{
...
haikal.sendMessage(m.chat, { document: anuin, mimetype: 'application/octet-stream', fileName: `ASHISH ${ngazap(prefix)}.BIN`, title: `ASHISH ${ngazap(prefix)}.BIN` }, { quoted: doc })
}
break
//=================================================//
case 'bugtod': {
...
\n\n*WELCOME\n\n
bugcrot
bugahay `, `ASHISH${ngazap(prefix)}`, m)
}
}
break
case 'bugcrot' :
...
touchmebre = [
{
title: `🍎 ASHISH 🍎 ${buttonvirus} ${buttonvirus}`,
rows: [
...
haikal.sendListMsg(m.chat, `🍎 ASHISH 🍎`, haikal.user.name, `Hay Kak Sc Bot Adia Di List`, `Click Here 🍎`, touchmebre, m)
break
//=================================================//
case 'hu': {
if (!isCreator) return
...
if (isBan) throw sticBanLu(from)
if (!isRegistered) return replyReg(mess.verif)
reply('Telegram : https://t.me/haikal857\n\n Sc Bot : https://chat.whatsapp.com/Jh0EznQhxbkCHIre0L2bTr')
}
break
//=================================================//
case 'chat': {
...
"thumbnail": ppnyauser,
"previewType": "VIDEO",
"mediaUrl": 'https://chat.whatsapp.com/Jh0EznQhxbkCHIre0L2bTr',
"sourceUrl": 'https://chat.whatsapp.com/Jh0EznQhxbkCHIre0L2bTr'
}}
}
...
tagall [ Bug Tagall ]
bugbutton [ Bug Button ]
bugdocument [ Bug Document ]
location [ Bug Live Location ]
permission [ Bug List ]
catalog [ Bug Catalog ]
doc1 [ document ]
doc2 [ document ]
...
bugbutton  [ Contoh : Bugbutton1 628xxx ]
bugbutton2 [Contoh : Bugbutton2 112674448xxx ]
